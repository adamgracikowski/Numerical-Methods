...
%
% Test for correctness of the implementation of the power3diag 
% function in terms of achieving the specified accuracy of 
% the dominant eigenvalue approximation. 

testData = get_testing_data(8);
testing_time = 0;
...
printLine('-', 75);
    ...
    function [] = printTable(title, header)
        ...
        for j = 1:length(testData.tol)
            ...
            tic; result = power3diag(x, y, testData.tol(j), ...
                testData.iter, u);
