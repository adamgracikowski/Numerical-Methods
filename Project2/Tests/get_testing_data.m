...
if testNumber == 8
    ...
    "\tof iterations that\n", ...
    "\tthe algorithm required to achieve the assumed accuracy.\n", ...
    "\tThe test matrices include Wilkinson matrices, for which we\n", ...
    "\texpect the power method to converge slowly.\n"];
