...
if testNumber == 2
    ...
    "\t(after transformation) obtained using transform3diag function,\n", ...
    "\tFrobenius norm: ||A - QR|| expressed in epsilons, where Q is\n", ...
    "\ta matrix created by multiplying transpositions of Householder\n", ...
    "\tmatrices in a reversed order and Frobenius norm: ||I - Q*Q'||\n", ...
    "\talso expressed as a multiple of epsilon, which tests\n", ...
    "\tif the matrix Q is orthonormal.\n"];
    testData.n = [2, 3, 4, 8, 10];
    testData.numOfTestCases = length(testData.n);
    testData.imin = 1;
    testData.imax = 9;
...
if testNumber == 3
    ...
    "\tvector b and the solution x (obtained by using transform3diag and\n", ...
    "\tbacksubs3diag). The correctnes of the solution is checked by\n", ...
    "\tevaluating the norm ||Ax - b|| and displaying it as a multiple\n", ...
    "\tof epsilons.\n"];
    testData.n = [2, 3, 4, 8, 10];
    testData.numOfTestCases = length(testData.n);
    testData.imin = 1;
...
if testNumber == 5
    ...
    "\tso as to enhance the speed of convergence of the eigenvalue\n", ...
    ...
    "\t- power.relative_difference/eps for the first table\n", ...
    "\t- inverse.relative_difference/eps for the second table\n", ...
...
if testNumber == 6
    ...
    "\trelative_difference returned by power3diag function.\n", ...
...
if testNumber == 7
    ...
    "\tline when presented on a logarithmic scale (on the Y-axis).\n", ...
    "\tThe slope of the line is evaluated based on the\n", ...
    "\trelative_difference returned by inverse3diag function.\n", ...
    "\tThen simple linear regression is applied on a vector of errors to\n", ...
    "\tfind the slope of the line. On the other side, it is known that the\n", ...
